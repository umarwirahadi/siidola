$(document).ready(function () {
	...
	$("#ttanggapan").on("click", "#tanggapan_file", function () {
		...
		$.ajax({
			url: url + 'document/modalTanggapan',
			type: 'post',
	...
	$("#btn_update").on("click", function (e) {
		...
		$.ajax({
			url: url + 'document/updatetanggapan',
			type: 'post',
	...
	$("#apdet").on("click", function (e) {
		...
		console.log(id_ok1);
		$.ajax({
			url: url + 'document/act_tanggapanfile',
			type: 'post',

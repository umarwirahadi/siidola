				...
				if (result.length > 0) {
					...
					for (i; i < result.length; i++) {
						...
						html += '<tr class="even pointer">' +
							...
							'<a href="javascript:void(0)" data-id-dok="' + result[i].id_document + '" id="' + result[i].id + '" class="btn btn-sm btn-success ajukan" title="Ajukan dokumen"><i class="fa fa-share"></i></a>' +
					...
					html += '<tr>' +
						'<td colspan="8">tidak ada draft yang akan diajukan</td>' +
						'</tr >';
				}
				$("#tbdraft").html(html);
			}
		...
		$.ajax({
			...
			success: function (result) {
				if (result.length > 0) {
					...
					html += '<tr' +
						'<td colspan="8">Belum dokumen yang diajukan</td>' +
						'</tr >';
				}
				$("#tbajuan").html(html);
			}
			...
			$("#tb_ajuan").DataTable({
				retrieve: true,
				// "dom": "<'row '<'col-sm-3'li> <'col-sm-6'f>  <'col-sm-3'B>>    <'row'<'col-sm-12'tr>>    <'row'<'col-sm-12'p>>",
				"dom": "<'row'<'col-sm-2'l><'col-sm-2'B><'col-sm-2'i><'col-sm-6'f>> <'row'<'col-sm-12'tr>>    <'row'<'col-sm-12'p>>",
				buttons: {
					buttons: [{
						extend: 'excel',
						className: 'btn btn-sm btn-primary',

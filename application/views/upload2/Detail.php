					...
					<tbody id="tbfiles">
						...
						?>
									<tr>
										...
										<td><?= $key->deskripsi ?></td>
										<td>
											<a href="<?= site_url('uploadss/download/' . $key->file_name) ?>" title="Download dokumen" class="btn btn-sm btn-round btn-primary"><span class="fa fa-cloud-download"></span> download</a>
											<?php
											if ($detail_data->status_dokumen == '6') {
											?>
